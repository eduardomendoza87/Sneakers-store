...
const WomenCollection = () => {
    ...
    // BASE DE DATOS: Obtenemos solo productos de Mujer
    const baseWomenProducts = products.filter(product => 
    ...
    const { 
        ...
        handleSizeChange, 
        handleSortChange 
    } = useProductFilters(baseWomenProducts);
      ...
      <div className="bg-transparent min-h-screen w-full overflow-x-hidden">
        ...
        <section className="px-6 md:px-10 py-16">
          <div className="relative w-full h-96 md:h-125 rounded-3xl overflow-hidden shadow-2xl">
            <img src={WomenHero} alt="Colección Mujer" className="absolute inset-0 w-full h-full object-cover object-center"/>
            <div className="absolute inset-0 bg-black/10" />
            <div className="absolute inset-0 flex items-center justify-start p-8 md:p-16">
              <div className="max-w-lg">
                <h2 className="text-4xl md:text-6xl font-bold text-white mb-4 leading-tight drop-shadow-lg font-clash">Esencia <br /> Minimalista</h2>
                <p className="text-white/90 font-sans text-lg md:text-xl font-medium drop-shadow-md">Menos ruido, más impacto. <br /> Descubre nuestra colección.</p>
              </div>
            </div>
          </div>
        </section>
